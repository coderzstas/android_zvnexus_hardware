...
#define FINGERPRINT_ONEPLUS8_HARDWARE_MODULE_ID     "goodix.fod"
#define FINGERPRINT_ONEPLUS8PRO_HARDWARE_MODULE_ID "goodix.g6.fod"
...
fingerprint_device_t* BiometricsFingerprint::openHal() {
    ...
    const char *id = FINGERPRINT_HARDWARE_MODULE_ID;
    int i=0;
    hw_device_t *device = nullptr;
    for (i=0; i<3; ++i) {
            switch (i) {
                case 0: id = FINGERPRINT_HARDWARE_MODULE_ID;
                        break;
                case 1: id = FINGERPRINT_ONEPLUS8_HARDWARE_MODULE_ID;
                        break;
                case 2: id = FINGERPRINT_ONEPLUS8PRO_HARDWARE_MODULE_ID;
                        break;
                default: id = FINGERPRINT_HARDWARE_MODULE_ID;
            }
            ...
            if (module->common.methods->open == nullptr) {
                ALOGE("No valid open method in module");
                hw_mdl = nullptr;
                continue;
            }
            ...
            if (0 != (err = module->common.methods->open(hw_mdl, nullptr, &device))) {
                ...
                ALOGD("Opening fingerprint hal library %s was successful", id);
                break;
            }
    }
